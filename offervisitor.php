...
<head>
  ...
  <title>Offer Visitor : Fairway Pharmaceuticals | The Right choice </title>
...
<body style="background: linear-gradient(to right, #2bc0e4, #eaecc6);">
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <header class="mdl-layout__header">
                  <div class="mdl-layout__header-row">
                    ...
                    <nav class="mdl-navigation mdl-layout--large-screen-only">
                      <a class="mdl-navigation__link" href="offervisitor.php"><i class="zmdi zmdi-home zmdi-hc-lg"></i> Dashboard</a>
    ...
    <div class="mdl-layout__drawer">
        <span class="mdl-layout-title">Fairway</span>
        <nav class="mdl-navigation">
                <a class="mdl-navigation__link" href="offervisitor.php"><i class="zmdi zmdi-card-giftcard"></i>&nbsp;Running Offers</a>
